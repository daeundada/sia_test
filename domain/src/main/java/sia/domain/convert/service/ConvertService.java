...
import sia.domain.convert.dto.request.BatchConvertRequestDTO;
import sia.domain.convert.dto.request.ConvertRequestDTO;
import sia.domain.convert.dto.response.MetadataListResponseDTO;
import sia.domain.convert.dto.response.MetadataResponseDTO;
import sia.domain.convert.entity.ImageMetadata;
import sia.domain.convert.repository.ImageMetadataRepository;
